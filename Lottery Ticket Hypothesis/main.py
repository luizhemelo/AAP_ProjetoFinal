...
nn1.compile(optimizer=optimizers.Adam(learning_rate=0.0002), loss=losses.BinaryCrossentropy(), metrics=["accuracy"])
...
nn.compile(optimizer=optimizers.Adam(learning_rate=0.0002), loss=losses.BinaryCrossentropy(), metrics=["accuracy"])
